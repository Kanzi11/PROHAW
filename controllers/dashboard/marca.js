...
const SAVE_MODAL = new Modal(document.getElementById('agregarmarca'),options);
        ...
        JSON.dataset.forEach(row=> {
            ...
            <tr>
                <td class="w-4 p-4">
                    ...
                    <td><img src="${SERVER_URL}img/marcas/${row.logo_marca}" class="materialboxed" height="100"></td>
                <td class="px-10 py-3">
                    <a onclick="openUpdate(${row.id_marca})"><i class="fa-sharp fa-solid fa-edit"></i></a>
                    <a onclick="openDelete(${row.id_marca})"><i class="fa-sharp fa-solid fa-trash"></i></a>
                </td>
            </tr>
        `;    
        }) 
