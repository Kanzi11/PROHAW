...
$pdf->startReport('Cantidad de productos por categoria');
// Se instancia el módelo Categoría para obtener los datos.
$categoria = new Categoria;
// Se verifica si existen registros para mostrar, de lo contrario se imprime un mensaje.
if ($dataCategoria = $categoria->reportCategorias()) {
    ...
    foreach ($dataCategoria as $rowCategoria) {
        ...
        $pdf->cell(40);
        $pdf->cell(46, 10, $pdf->encodeString($rowCategoria['nombre_categoria']), 1, 0,'C');
        $pdf->cell(60, 10, $pdf->encodeString($rowCategoria['cantidad_producto']), 1, 1,'C');
    }
} else {
